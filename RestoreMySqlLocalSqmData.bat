...
c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 < local_sqmdata.txt
timeout /t 1 /nobreak
...
c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmdata< "Bak_sqmdata_onlyst1_%VAR_ULTDIA%.sql" 
echo Termino en proceso restauracion de archivo "Bak_sqmdata_onlyst1_%VAR_ULTDIA%.sql"

c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmdata< "Bak_sqmdata_onlyst2_%VAR_ULTDIA%.sql"
echo Termino en proceso restauracion de archivo "Bak_sqmdata_onlyst2_%VAR_ULTDIA%.sql"

c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmplani< "Bak_sqmplani_onlyst_%VAR_ULTDIA%.sql"
echo Termino en proceso restauracion de archivo "Bak_sqmplani_onlyst_%VAR_ULTDIA%.sql"


c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmdata< "Bak_Sqmdata1_%VAR_ULTDIA%.sql" 
echo Termino en proceso restauracion de archivo "Bak_Sqmdata1_%VAR_ULTDIA%.sql" 

c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmdata< "Bak_Sqmdata2_%VAR_ULTDIA%.sql" 
echo Termino en proceso restauracion de archivo "Bak_Sqmdata2_%VAR_ULTDIA%.sql"

c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmplani< "Bak_sqmplani_%VAR_ULTDIA%.sql"
echo Termino en proceso restauracion de archivo "Bak_sqmplani_%VAR_ULTDIA%.sql"


c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmdata< "Bak_sqmdata_sp_%VAR_ULTDIA%.sql"
echo Termino en proceso restauracion de archivo "Bak_sqmdata_sp_%VAR_ULTDIA%.sql"

c:\xampp\mysql\bin\mysql -hlocalhost -uroot -p987654321 --port=3387 sqmplani< "Bak_sqmplani_sp_%VAR_ULTDIA%.sql"
